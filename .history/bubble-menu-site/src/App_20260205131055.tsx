...
const teamCards: TeamCard[] = [
  ...
  },
  {
    ...
    altText: 'Агата',
    caption: 'Агата',
    overlay: 'Агата · Design'
  },
  {
    imageSrc: '/avatars/liza.jpeg',
    altText: 'Лиза',
    caption: 'Лиза',
    overlay: 'Лиза · Community'
  },
  {
    imageSrc: '/avatars/sofa.jpeg',
    altText: 'Софья',
    caption: 'Софья',
    overlay: 'Софья · Education'
  },
  {
  ...
  },
  {
    ...
    altText: 'Родион Азаренок',
    caption: 'Родион Азаренок',
    overlay: 'Родион Азаренок\nИнженер-электрик'
  },
  {xc…•∆ƒmљl≤≥ї«єї≥«“‘'ѕѓњ†ќўџџјdzћ÷÷……•∆љљll«
