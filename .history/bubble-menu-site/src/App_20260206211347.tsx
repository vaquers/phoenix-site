...
const PROJECT_START_DATE = new Date('2024-10-24T00:00:00');
        ...
        return (
          <section id="about" className="section about-section">
            <div className="container">
              <h2 className="section-title">Phoenix LBSU <br /> FTC Team #28420</h2>
              <p className="section-text about-intro">
              ...
              <div className="about-stats" role="group" aria-label="Ключевые показатели">
                <div className="about-stat-card">
                  <div className="about-stat-icon">
                    <img src="/symbols/trophy.svg" alt="" width={40} height={40} />
                  </div>
                  <span className="about-stat-value">{YEARS_IN_COMPETITIONS}</span>
                  <span className="about-stat-label">лет в соревнованиях</span>
                </div>
                <div className="about-stat-card">
                  <div className="about-stat-icon">
                    <img src="/symbols/person.2.svg" alt="" width={40} height={40} />
                  </div>
                  <span className="about-stat-value">{teamCards.length}</span>
                  <span className="about-stat-label">в команде</span>
                </div>
                <div className="about-stat-card about-stat-card-uptime">
                  <div className="about-stat-icon">
                    <img src="/symbols/calendar.svg" alt="" width={40} height={40} />
                  </div>
                  ...
                  <span className="about-stat-label">проекту</span>
                </div>
              </div>
