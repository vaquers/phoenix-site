...
const teamMembers: TeamMember[] = [
  ...
  {
    name: 'Мария Ковалёва',
    title: 'Software Engineer · Control',
    handle: 'maria.k',
    status: 'Online',
    avatarUrl: '/avatars/maria.jpg',
    behindGlowColor: 'rgba(244, 114, 182, 0.8)'
  },
  {
    name: 'Илья Соколов',
    title: 'ML Engineer',
    handle: 'ilya.ml',
    status: 'Online',
    avatarUrl: '/avatars/ilya.jpg',
    behindGlowColor: 'rgba(56, 189, 248, 0.8)'
  },
  {
    name: 'Дарья Орлова',
    ...
    handle: 'daria.design',
    status: 'Online',
    avatarUrl: '/avatars/daria.jpg',
    behindGlowColor: 'rgba(250, 204, 21, 0.8)'
  },
  {
    name: 'Сергей Лебедев',
    ...
    handle: 'sergey.hw',
    status: 'Online',
    avatarUrl: '/avatars/sergey.jpg',
    behindGlowColor: 'rgba(45, 212, 191, 0.8)'
  },
  {
    name: 'Анна Власова',
    ...
    behindGlowColor: 'rgba(129, 140, 248, 0.8)'
  },
  {
    name: 'Роман Смирнов',
  ...
  },
  {
    ...
    handle: 'kate.community',
    status: 'Online',
    avatarUrl: '/avatars/kate.jpg'
  },
  {
              ...
              <div className="team-grid">
                {teamMembers.map(member => (
                  <ProfileCard
                    ...
                    innerGradient={
                      member.innerGradient ?? 'linear-gradient(145deg,#60496e8c 0%,#71C4FF44 100%)'
                    }
                    onContactClick={() => {
                      // eslint-disable-next-line no-console
                      console.log(`Contact ${member.handle}`);
                    }}
                  />
                ))}
              </div>
