...
const sponsorItems: SponsorItem[] = [
  {
    ...
    description: 'Лучшее учреждение среднего образования в Беларуси.',
    rank: 1
  },
  {
    image: '/sponsors/silver.png',
    name: 'НПО СтарЛайн',
    description: 'Мировой лидер рынка автобезопасности с компетенциями в областях автоматизации, роботизации, телематики и беспилотных технологий.',
    rank: 2
  },
  {
    image: '/sponsors/bronze.png',
    name: 'Кубок по образовательной робототехнике',
    description: 'Серия турниров по образовательной робототехнике, которые проводятся в различных населенных пунктах Республики Беларусь.',
    rank: 3
  },
  {
    image: '',
    name: 'Станьте спонсором команды Phoenix',
    description: 'Станьте спонсором команды Phoenix и помогите нам создавать технологии будущего.'
  },
  {
    image: '',
    name: 'Станьте спонсором команды Phoenix',
