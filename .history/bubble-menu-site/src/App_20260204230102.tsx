        ...
        return (
          <section id="team" className="section">
            <div className="container">
              ...
              <p className="section-text">
              Это страстные и увлеченные своей работой члены команды «Phoenix LBSU». Наша команда объединяет экспертов в области программирования, моделирования, проектирования и работы с сообществом для создания инновационных решений в области робототехники.
              </p>
              <div className="section-card">
        ...
        <header className="hero">
          <div className="container">
            ...
            <p className="hero-subtitle">
              Стартовая страница сообщества с BubbleMenu, где каждый раздел открыт на своей виртуальной странице.
            </p>
          </div>
        </header>
