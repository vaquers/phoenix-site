                    ...
                    <div className="contact-card contacts-form-wrap">
                      ...
                      <form className="contact-form" onSubmit={handleContactSubmit}>
                        <label className="contact-form-label">
                          ФаИмя <span className="contact-form-required">*</span>
          ...
          <section id="join" className="section">
            <div className="container">
              ...
              <div className="join-form-card">
                {joinSubmitted ? (
                  <div className="contact-form join-form">
                    <h3 className="contact-form-title">Заявка отправлена</h3>
                    <p className="contact-form-text">
                      Спасибо! Мы получили твою заявку и скоро свяжемся с тобой.
                    </p>
                  </div>
                ) : (
                  <form
                  ...
                  >
                    <label className="contact-form-label">
                      ...
                      <input type="text" className="contact-form-input" placeholder="Введите ФИО" required />
                    </label>
                    <div className="join-form-row">
                      <label className="contact-form-label">
                        Параллель <span className="contact-form-required">*</span>
                        <select className="contact-form-input contact-form-select" required defaultValue="">
                          <option value="" disabled>Выбери параллель</option>
                      ...
                      <label className="contact-form-label">
                        ...
                        <select className="contact-form-input contact-form-select" required defaultValue="">
                          <option value="" disabled>Выбери профиль</option>
